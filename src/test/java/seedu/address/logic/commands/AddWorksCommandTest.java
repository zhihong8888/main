...
public class AddWorksCommandTest {
     ...
     * 1) Condition: Schedule 5 work schedules with different date.
     * 2) Schedule the same 5 work schedules -> throws exception
     * @throws Exception
     */
    @Test
    ...
    public void execute_scheduleWorkOnSomeOverlappingLeaveSchedule_throwsCommandException() throws Exception {
        ...
        Set<Date> dateWorkSet = new HashSet<>();
        dateWorkSet.add(MONDAY_16_JUN_2025);
        dateWorkSet.add(TUESDAY_17_JUN_2025);
        dateWorkSet.add(WEDNESDAY_16_JUN_2025);
        dateWorkSet.add(THURSDAY_19_JUN_2025);
        dateWorkSet.add(FRIDAY_20_JUN_2025);
