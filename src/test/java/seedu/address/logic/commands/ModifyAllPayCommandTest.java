 ...
 * and unit tests for ModifyAllPayCommand.
 */
public class ModifyAllPayCommandTest {
    ...
    public void execute_someFieldsSpecified_success() {
        ...
        String expectedMessage = String.format(Messages.MESSAGE_MODIFIED_PAY_OVERVIEW, 7);
        ...
        try {
            assertCommandSuccess(modifyAllPayCommand, model, commandHistory, expectedMessage, expectedModel);
    ...
    public void execute_noFieldSpecified_success() {
        ModifyAllPayCommand modifyAllPayCommand = new ModifyAllPayCommand(new ModSalaryDescriptor());
    ...
    public void execute_filteredList_success() {
        ...
        ModifyAllPayCommand modifyAllPayCommand = new ModifyAllPayCommand(
                new ModAllSalaryDescriptorBuilder().withSalary(VALID_SALARY_BOB).build());
    ...
    public void execute_lowerBoundValueSalary_failure() throws ParseException {
        ...
        try {
            assertCommandFailure(modifyAllPayCommand, model, commandHistory, ModifyPayCommand.MESSAGE_NEGATIVE_PAY);
        } catch (AssertionError ae) {
            ae.printStackTrace();
        }
    }
    ...
    public void execute_upperBoundValueSalary_failure() throws ParseException {
        ...
        assertCommandFailure(modifyAllPayCommand, model, commandHistory, Salary.MESSAGE_SALARY_CONSTRAINTS);
    }
    ...
    public void execute_lowerBoundValueSalary_success() throws ParseException {
        ...
        try {
            assertCommandSuccess(modifyAllPayCommand, model, commandHistory,
    ...
    public void execute_upperBoundBonus_failure() {
        ...
        assertCommandFailure(modifyAllPayCommand, model, commandHistory, Bonus.MESSAGE_BONUS_CONSTRAINTS);
    }
    ...
    public void executeUndoRedo_validIndexFilteredList_samePersonModified() throws Exception {
        ...
        ModSalaryDescriptor descriptor = new ModAllSalaryDescriptorBuilder(modifiedPerson).build();
        ModifyAllPayCommand modifyAllPayCommand = new ModifyAllPayCommand(descriptor);
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), model.getExpensesList(),
                model.getScheduleList(), model.getRecruitmentList(), new UserPrefs());
        ...
        modifyAllPayCommand.execute(model, commandHistory);
    ...
    @Test
    public void equals() {
        final ModifyAllPayCommand standardCommand = new ModifyAllPayCommand(PAY_ALL);

        // same values -> returns true
        ModSalaryDescriptor copyDescriptor = new ModSalaryDescriptor(PAY_ALL);
        ModifyAllPayCommand commandWithSameValues = new ModifyAllPayCommand(copyDescriptor);
