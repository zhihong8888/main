...
public class AddWorksCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + DATE_SCHEDULE_DESC_BOB, new AddWorksCommand(dateSet));
    }
    ...
    public void parse_multipleFields_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + DATE_SCHEDULE_DESC_BOB
                + DATE_SCHEDULE_DESC_CARL + DATE_SCHEDULE_DESC_DONNIE, new AddWorksCommand(dateSet));
    }

    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddWorksCommand.MESSAGE_USAGE);
