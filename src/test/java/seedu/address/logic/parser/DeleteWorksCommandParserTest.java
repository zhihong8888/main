...
public class DeleteWorksCommandParserTest {
    private DeleteWorksCommandParser parser = new DeleteWorksCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + DATE_SCHEDULE_DESC_BOB,
                new DeleteWorksCommand(dateSet));
    }
    ...
    public void parse_multipleFields_success() {
        ...
        // multiple dates
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + DATE_SCHEDULE_DESC_BOB
                + DATE_SCHEDULE_DESC_CARL + DATE_SCHEDULE_DESC_DONNIE, new DeleteWorksCommand(dateSet));
    }

    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteWorksCommand.MESSAGE_USAGE);
