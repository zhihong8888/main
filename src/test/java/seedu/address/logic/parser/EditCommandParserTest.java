...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_POSITION_DESC, Position.MESSAGE_POSITION_CONSTRAINTS); // invalid position
        ...
        // valid address followed by invalid phone.
        assertParseFailure(parser, "1" + ADDRESS_DESC_BOB + INVALID_PHONE_DESC, Phone.MESSAGE_PHONE_CONSTRAINTS);
