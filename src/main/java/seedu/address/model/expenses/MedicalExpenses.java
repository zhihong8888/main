...
public class MedicalExpenses {
    ...
    public static final String MESSAGE_MEDICAL_EXPENSES_CONSTRAINTS =
            "Medical Expenses should only contain numbers, and it should be at least 1 digits long";
    public static final String EMPLOYEE_MEDICAL_EXPENSES_VALIDATION_REGEX = "-?[0-9]{1,10}+(.[0-9]{1,2})?";
