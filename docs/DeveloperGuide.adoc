...
// tag::filter[]
=== Filter Feature
The command `filter` allows the user to filter employees based on their respective department and/or positions within the company.
...
[NOTE]
If the input does not conform with the required format, an error message will be shown to the user.
...
public FilterCommand parse(String args) throws ParseException {
    ...
    FilterCommand filterCommand = new FilterCommand(new DepartmentContainsKeywordsPredicate(Arrays.asList(departmentKeywords)), new PositionContainsKeywordsPredicate(Arrays.asList(positionKeywords)));
    ...
    if (argMultimap.getValue(PREFIX_DEPARTMENT).isPresent()) {
        ...
        if (areDepartmentKeywordsValid(departmentKeywords)) {
            ...
            filterCommand.setDepartmentPredicate(new DepartmentContainsKeywordsPredicate(Arrays.asList(departmentKeywords)));
    ...
    if (argMultimap.getValue(PREFIX_POSITION).isPresent()) {
        ...
        if (arePositionKeywordsValid(positionKeywords)) {
            ...
            filterCommand.setPositionPredicate(new PositionContainsKeywordsPredicate(Arrays.asList(positionKeywords)));
