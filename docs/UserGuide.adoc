...
For commands similar functions to (list*, find*, filter*,
select*, calculate*, the command will not be able to undo or redo)
====
...
|Add Works Schedule Command
|addWorks
|aw

|Delete Works Schedule Command
|deleteWorks
|dw

|Add Leaves Schedule Command
|addLeaves
|al

|Delete Leaves Schedule Command
|deleteLeaves
|dl

|Calculate Leaves Command
|calculateLeaves
|cl
