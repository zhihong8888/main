...
|=======================================================================
|Field Name |Prefix |Limitations
|JOB_POSITION |jp/ | Job position must not be blank and should not include numbers and punctuation mark. And users are
...
|JOB_DESCRIPTION |jd/ | Job description must not be blank and should not include numbers and punctuation mark. And users
