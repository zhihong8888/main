...
=== Filtering and listing of specific employee's data: `filter`
...
=== Selecting an employee : `selectPerson`
...
=== Delete a existing schedule: `deleteSchedule`
...
|Filtering and listing of specific employee's data.
|filter
|-
...
|Editing an existing employee's data
|edit
|-
