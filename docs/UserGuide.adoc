...
Modify the salary/bonus of the employee identified by the index.
...
|Modify an employee's salary and/or bonus
|modifyPay
|mp

|Modify either the salary and/or bonus of all listed employees
|modifyAllPay
|map
