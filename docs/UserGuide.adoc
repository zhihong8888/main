...
|=======================================================================
|Field Name |Prefix |Limitations
|Job Position |jp/ | Job position accepts only characters. It must not be blank and should not include numbers and
...
|Job description |jd/ | Job description accepts only characters. It must not be blank and should not include numbers.
